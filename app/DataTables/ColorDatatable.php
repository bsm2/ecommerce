...
class ColorDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('edit', 'dashboard.colors.btns.edit')
            ->addColumn('delete', 'dashboard.colors.btns.delete')
            ->addColumn('checkbox', 'dashboard.colors.btns.checkbox')
            ->addColumn('color', 'dashboard.colors.btns.color')
            ->rawColumns(['edit','delete','checkbox','color']);
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\ColorDatatable $model
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('color')->title(__('site.color')),
