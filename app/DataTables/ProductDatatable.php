...
class ProductDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('edit', 'dashboard.products.btns.edit')
            ->addColumn('delete', 'dashboard.products.btns.delete')
            ->addColumn('checkbox', 'dashboard.products.btns.checkbox')
            ->rawColumns(['edit','delete','checkbox','Product']);
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('title' )->title(__('site.title')),
            Column::make('content')->title(__('site.content')),
