...
class TrademarkDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('edit', 'dashboard.trademarks.btns.edit')
            ->addColumn('delete', 'dashboard.trademarks.btns.delete')
            ->addColumn('checkbox', 'dashboard.trademarks.btns.checkbox')
     ...
     *
     * @param \App\Models\TrademarkDatatable $model
