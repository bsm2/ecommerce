...
class ManufacturerDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('edit', 'dashboard.manufacturers.btns.edit')
            ->addColumn('delete', 'dashboard.manufacturers.btns.delete')
            ->addColumn('checkbox', 'dashboard.manufacturers.btns.checkbox')
     ...
     *
     * @param \App\Models\ManufacturerDatatable $model
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('contact')->title(__('site.name')),
