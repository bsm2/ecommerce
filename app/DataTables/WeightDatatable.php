...
class WeightDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('edit', 'dashboard.weights.btns.edit')
            ->addColumn('delete', 'dashboard.weights.btns.delete')
            ->addColumn('checkbox', 'dashboard.weights.btns.checkbox')
     ...
     *
     * @param \App\Models\WeightDatatable $model
