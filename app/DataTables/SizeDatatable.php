...
class SizeDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('edit', 'dashboard.sizes.btns.edit')
            ->addColumn('delete', 'dashboard.sizes.btns.delete')
            ->addColumn('checkbox', 'dashboard.sizes.btns.checkbox')
            ->addColumn('is_public', 'dashboard.sizes.btns.public')
            ->rawColumns(['edit','delete','checkbox','is_public']);
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\SizeDatatable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Size $model)
    {
        return $model->newQuery()->with('category')->select('sizes.*');
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('category.name_'.lang())->title(__('site.category')),
            Column::make('is_public')->title(__('site.public')),
