...
class ShippingDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('edit', 'dashboard.shippings.btns.edit')
            ->addColumn('delete', 'dashboard.shippings.btns.delete')
            ->addColumn('checkbox', 'dashboard.shippings.btns.checkbox')
    ...
    {
        return $model->newQuery()->with('user')->select('shippings.*');;
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('user.name')->title(__('site.company')),
