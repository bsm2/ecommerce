                ...
                <div class="col-12">
                    ...
                    <!-- /.card-header -->
                        <div class="card-body table-responsive " >
                            {!! Form::open(['id'=>'form-data','route'=>'dashboard.product.destroy.all','method'=>'delete']) !!}
                    ...
                    <div class="card border-0 p-sm-3 p-2 justify-content-center">
                        <div class="empty-records " hidden>
                            <div class=" card-header pb-0 bg-white border-0">
                                ...
                                <p class="font-product-bold mb-2"> @lang('site.no_chosen_records')</p>
                            </div>
                        ...
                        <div class="not-empty-records" hidden>
                            <div class="hidden card-header pb-0 bg-white border-0  ">
                                ...
                                <p class="font-product-bold mb-2">@lang('site.are_you_sure_all')</p>
