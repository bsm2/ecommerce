                ...
                <div class="col-12">
                    ...
                    <!-- /.card-header -->
                        <div class="card-body table-responsive " >
                            ...
                            {!! Form::open(['route'=>['dashboard.size.update',$size->id],'method'=>'PUT']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="category_id" class="category-id" value="{{$size->category_id}}">
                                <div id="jstree"></div>
                                <div class="clearfix"></div>
                            </div>
