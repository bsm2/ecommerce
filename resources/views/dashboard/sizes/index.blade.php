...
@section('content')
    @section('breadcumb')
        <li class="breadcrumb-item active">@lang('site.sizes') </li>
    @endsection
    <!-- Main content -->
                ...
                <div class="col-12">
                    <div class="card  ">
                        <div class="card-header">
                            <h3 class="card-title ">@lang('site.sizes')</h3>
                        </div>
                    <!-- /.card-header -->
                        <div class="card-body table-responsive " >
                            {!! Form::open(['id'=>'form-data','route'=>'dashboard.size.destroy.all','method'=>'delete']) !!}
