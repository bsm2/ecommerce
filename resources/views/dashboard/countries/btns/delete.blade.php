...
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#del-this-{{$id}}">
    <i class="fa fa-trash"></i>
</button>

{{-- delete model --}}
<div id="del-this-{{$id}}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content border-0">
            {!! Form::open(['route'=>['dashboard.country.destroy',$id],'method'=>'delete']) !!}
                    ...
                    <div class="card border-0 p-sm-3 p-2 justify-content-center">
                        <div class="not-empty-records">
                            <div class=" card-header pb-0 bg-white border-0  ">
                                ...
                                <p class="font-weight-bold mb-2">@lang('site.are_you_sure') {{ $name}}</p>
                            </div>
