...
@section('breadcumb')
    <li class="breadcrumb-item active"><a href="{{route('dashboard.weight.index')}}">@lang('site.weights')</a></li>
                ...
                <div class="col-12">
                    ...
                    <!-- /.card-header -->
                        <div class="card-body table-responsive " >
                            ...
                            {!! Form::open(['route'=>'dashboard.weight.store','method'=>'POST','files'=>true]) !!}
