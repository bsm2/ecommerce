...
@section('content')
    @section('breadcumb')
        <li class="breadcrumb-item active">@lang('site.weights') </li>
    @endsection
    <!-- Main content -->
                ...
                <div class="col-12">
                    <div class="card  ">
                        <div class="card-header">
                            <h3 class="card-title ">@lang('site.weights')</h3>
                        </div>
                    <!-- /.card-header -->
                        <div class="card-body table-responsive " >
                            {!! Form::open(['id'=>'form-data','route'=>'dashboard.weight.destroy.all','method'=>'delete']) !!}
